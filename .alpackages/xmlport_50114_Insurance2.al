xmlport 50114 InsuranceImport2
{
    ...
    DefaultNamespace = 'urn:microsoft-dynamics/ImportInsurance';
    ...
    schema
    {
        textelement(root)
        {
            tableelement(PurHdr; "Purchase Header")
            {
                ...
                //textelement(Dummy) { MinOccurs = Zero; }
                ...
                begin
                    /*
                        ...
                        if booNotFirstLine = false then begin
                            ...
                            tblPurLine.Validate("Unit of Measure", 'SERVICE');
