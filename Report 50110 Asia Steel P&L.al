report 50110 "Asia Steel P&L"
{
    DefaultLayout = RDLC;
    RDLCLayout = './RDLC/AccountSchedule.rdl';
        ...
        dataitem(AccScheduleName; "Acc. Schedule Name")
        {
            ...
            dataitem(Heading; "Integer")
            {
                ...
                dataitem("Acc. Schedule Line"; "Acc. Schedule Line")
                {
                    ...
                    dataitem("Temp Account Schedule"; "Temp Account Schedule")
                    {
                        ...
                        begin
                            SetFilter("G/L Account", '%1', "Acc. Schedule Line".Totaling);
                            //  Message('%1 count ,%2', "Acc. Schedule Line".Totaling, "Temp Account Schedule".Count);
                        end;
    ...
    begin
        l_recTempAccountSchedule.InitAsiaPNLData(StartDate, EndDate);
        TransferValues;
        UpdateFilters;
        InitAccSched;
    end;
    ...
    begin
        ...
        PeriodText := Format(EndDate, 0, '<Month Text>-<Year>');
